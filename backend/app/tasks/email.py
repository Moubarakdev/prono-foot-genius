...
def send_otp_email(email: str, otp_code: str, name: str = ""):
    ...
    subject = "FootGenius - Votre code de vérification"
    ...
    <html>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <p>Bonjour {name},</p>
                <p>Merci de vous être inscrit sur <strong>FootGenius</strong>. Voici votre code de vérification à usage unique (OTP) :</p>
...
def send_reset_password_email(email: str, otp_code: str, name: str = ""):
    ...
    subject = "FootGenius - Réinitialisation de votre mot de passe"
    ...
    <html>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <p>Bonjour {name},</p>
                <p>Vous avez demandé la réinitialisation de votre mot de passe <strong>FootGenius</strong>. Utilisez le code suivant pour procéder :</p>
                <div style="text-align: center; margin: 30px 0; padding: 15px; border-radius: 8px; background-color: #f3f4f6; font-size: 24px; font-weight: bold; letter-spacing: 5px; color: #111827;">
                    {otp_code}
                </div>
                ...
                <hr style="border: 0; border-top: 1px solid #eee; margin: 30px 0;">
                <p style="font-size: 12px; color: #9ca3af; text-align: center;">&copy; 2025 FootGenius. Tous droits réservés.</p>
            </div>
        </body>
    </html>
    """
